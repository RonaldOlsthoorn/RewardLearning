function [ protocol ] = viapoint_advancedx_var_single_manual()
...
reference_par.plane_dim = 'x';
reference_par.plane_level = 0.5;
...
env_par.expert = 'manual_advanced_expert';
%env_par.expert_std = 0.002;
env_par.expert_std = 0.032;
env_par.tol = 1e-1;

reward_model.type = 'viapoint_var_single_gp';
