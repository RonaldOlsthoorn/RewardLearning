        ...
        function rating = query_expert(obj, rollout)
            ...
            for i = 1:obj.n_segments
                ...
                if obj.ref.plane.t(1)>= obj.segment_start(i)*obj.ref.Ts && ...
                        ...
                        rating(i) = rating(i) - 1*mean(sum(...
                            (rollout.tool_positions(:, obj.segment_start(i):obj.segment_end(i))'...
                            -obj.ref.plane.tool').^2, 2)) + ...
                            obj.std*randn();
                end
                ...
                for j = 1:length(obj.ref.viapoints(1,:))
                    ...
                    if obj.ref.viapoints_t(j)>= obj.segment_start(i) && ...
                        ...
                        rating(i) = rating(i) - 0*sum((rollout.tool_positions(:, obj.ref.viapoints_t(j))'...
