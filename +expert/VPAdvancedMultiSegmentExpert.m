            ...
            for i = 1:obj.n_segments
                ...
                if obj.ref.viaplane_t(1)>= obj.segment_start(i) && ...
                        ...
                        rating(i) = rating(i) - 10000000*mean(sum(...
                            (rollout.tool_positions(:, obj.ref.viaplane_t(1):obj.ref.viaplane_t(2))'...
                            -repmat(obj.ref.viaplane',obj.ref.viaplane_t(2)-obj.ref.viaplane_t(1)+1,1)).^2, 2)) + ...
                            
                        rating(i) = rating(i) - mean(sum(...
