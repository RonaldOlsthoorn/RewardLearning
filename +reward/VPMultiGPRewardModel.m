classdef VPMultiGPRewardModel < reward.RewardModel
    ...
    methods
        ...
        % Perform gp inference for specific rollout on segment. Assumed rollout has
        % feature outcomes.
        ...
        % returns true if the gps training points contain a segment of this
        % rollout. Segment specific selection not implemented yet.
        ...
        function print(obj)
            ...
            for i = 1:obj.n_segments
                ...
                for j = 1:length(x_grid)
                    ...
                    if length(obj.gps(i).x_measured(1,:)) == 2
                        tuples = [x_grid(:,j), y_grid(:,j)]; 
                    elseif length(obj.gps(i).x_measured(1,:)) == 4
