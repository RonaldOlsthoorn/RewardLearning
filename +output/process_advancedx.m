...
% Load saved figures
c=hgload('+output/advancedx/convergence_single_noise.fig');
k=hgload('+output/advancedx/convergence_multi_noise.fig');
% Prepare subplots
...
savefig('+output/advancedx/convergence_combi_noise');
print('+output/advancedx/convergence_combi_noise', '-depsc');
