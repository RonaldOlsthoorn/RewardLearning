...
% viapoint_advancedx_single_manual and viapoint_advancedx_multi_manual
%
%%
% set globals
...
savefig('+output/advancedx/convergence_single_manual');
print('+output/advancedx/convergence_single_manual', '-depsc');
